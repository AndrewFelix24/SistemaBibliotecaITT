...
const supabase = createClient(
  "https://yfojzdyjdruzheeodpjs.supabase.co",
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inlmb2p6ZHlqZHJ1emhlZW9kcGpzIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTk3NjI1NDksImV4cCI6MjA3NTMzODU0OX0.krfcZgU6IPkJdc1UkclkFk2z7uptev2ucHvm-lvOiXU"
);
const User = () => {
  ...
  const menuItems = [
    ...
    { name: "Library", subItems: ["Books", "Generate Reports", "Loans"] },
...
const styles = {
  ...
  form: { display: "flex", flexDirection: "column", gap: "1rem", width: "60rem" },
  input: {
    padding: "0.75rem",
    fontSize: "1rem",
    borderRadius: 4,
